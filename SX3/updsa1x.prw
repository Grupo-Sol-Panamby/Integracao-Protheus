...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDSA1X" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDSA1X" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aHlpPor := {}
aAdd( aHlpPor, 'Complemento do endereço de cobrança' )

PutHelp( "PA1_XCOMPLE", aHlpPor, {}, {}, .T. )
AutoGrLog( "Atualizado o Help do campo " + "A1_XCOMPLE" )

aHlpPor := {}
aAdd( aHlpPor, 'Bairro de cobrança' )
